...
1. Data Wrangling: Join 2 datasets together to form the alko_data.csv. 
2. Data Analysis: Study the relationship between high/low alcohol consumption and other variables.  
...
1) alko_use as the average of the answers related to weekday and weekend alcohol consumption. 
2) logical data TRUE for students for which 'alko_use' is greater than 2 (and FALSE otherwise. 
